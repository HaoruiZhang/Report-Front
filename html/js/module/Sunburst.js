...
const Sunburst = {
            ...
            click: function (gd) {
              ...
              var new_bottom = {
                ...
                modeBarButtonsToAdd: [{
                  ...
                  click: function (gd) {
                    var noTextInfo = { textinfo: "none" };
                    Plotly.react('microbe-sunburst-plot', props.plotData, layout, config);
                    Plotly.restyle(gd, noTextInfo);
                  }
                }]
              };
              Plotly.react('microbe-sunburst-plot', props.plotData, layout, new_bottom);
              Plotly.restyle(gd, newTextInfo);
            }
          },
        ]
      };
      Plotly.newPlot('microbe-sunburst-plot', props.plotData, layout, config);
    });
  ...
  template: `
    <div class="module-content-right" style=" width: 576px;height: calc(100% - 24px);display: flex;justify-content: center;align-items: center;background-color: #ffffff;">
      <div class="microbe-plot" id="microbe-sunburst-plot" style="width: 100%;height: 100%;">
      </div>
    </div>
  `
};